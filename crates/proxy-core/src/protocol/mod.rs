...
pub use dimension_codec::{
    ...
    config_codec_nameless_for_proto, determine_injection_mode, dimension_type_nbt,
    dimension_type_nbt_for_proto, needs_codec_injection, uses_dimension_codec, CodecInjectionMode,
};
