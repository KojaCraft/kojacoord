...
const PLAY: &[Entry] = &[
    ...
    // ── proto 775 (26.1 / 26.1.1 / 26.1.2) — ViaVersion ClientboundPackets26_1
    //   / ServerboundPackets26_1 ordinals (two clientbound packets inserted
    //   over 1.21.11 shift the play ids).
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundBossBar", 0x09),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundPluginMessage", 0x18),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundCustomPayload", 0x18),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundDisconnect", 0x20),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundKeepAlive", 0x2c),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundLevelChunkWithLight", 0x2d),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundJoinGame", 0x31),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundLogin", 0x31),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundPlayerAbilities", 0x40),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundPlayerPosition", 0x48),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundRespawn", 0x52),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundSetHeldItem", 0x69),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundSetCarriedItem", 0x69),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundSound", 0x75),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundNamedSoundEffect", 0x75),
    (775, ProtocolState::Play, Direction::Clientbound, "ClientboundSystemChat", 0x79),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundChatCommand", 0x07),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundChatMessage", 0x09),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundPluginMessage", 0x16),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundCustomPayload", 0x16),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundKeepAlive", 0x1c),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundMovePlayerPos", 0x1e),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundMovePlayerPosRot", 0x1f),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundMovePlayerRot", 0x20),
    (775, ProtocolState::Play, Direction::Serverbound, "ServerboundMovePlayerStatusOnly", 0x21),

    // ── proto 776 (26.2) — no ViaVersion mapping yet; mirrors 26.1 layout.
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundBossBar", 0x09),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundPluginMessage", 0x18),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundCustomPayload", 0x18),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundDisconnect", 0x20),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundKeepAlive", 0x2c),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundLevelChunkWithLight", 0x2d),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundJoinGame", 0x31),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundLogin", 0x31),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundPlayerAbilities", 0x40),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundPlayerPosition", 0x48),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundRespawn", 0x52),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundSetHeldItem", 0x69),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundSetCarriedItem", 0x69),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundSound", 0x75),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundNamedSoundEffect", 0x75),
    (776, ProtocolState::Play, Direction::Clientbound, "ClientboundSystemChat", 0x79),
    (776, ProtocolState::Play, Direction::Serverbound, "ServerboundChatCommand", 0x07),
    (776, ProtocolState::Play, Direction::Serverbound, "ServerboundChatMessage", 0x09),
    (776, ProtocolState::Play, Direction::Serverbound, "ServerboundPluginMessage", 0x16),
    (776, ProtocolState::Play, Direction::Serverbound, "ServerboundCustomPayload", 0x16),
    (776, ProtocolState::Play, Direction::Serverbound, "ServerboundKeepAlive", 0x1c),
    (776, ProtocolState::Play, Direction::Serverbound, "ServerboundMovePlayerPos", 0x1e),
